			...
			$(document).ready( function() {
                setTimeout( function() {
                    tinyMCE.init({
                        ...
                        theme_advanced_buttons1 : "bold,italic,underline,|,justifyleft,justifycenter,justifyright,justifyfull,bullist,numlist,link,unlink,|,code,spellchecker,|,image,jbimages",
