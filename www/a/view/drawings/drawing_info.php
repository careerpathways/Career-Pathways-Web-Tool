    ...
    <table width="960">
        ...
        <tr>
            ...
            <td>
                ...
                ?>
                <input type="radio" class="true" name="show_pdf_ada_links" <?= $show_pdf_ada_links === true ? 'checked="checked"':'' ?> value="true"> Yes, show "Text-Only | Printable PDF" at the top-right of the published drawing.
                <br>
