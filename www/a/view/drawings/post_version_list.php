		...
		foreach( $versions as $v ) {
			...
			echo '<td class="border" width="400" valign="top"><table height="80">';
				echo '<tr>';
					...
					echo '<td><span class="version_title">Version '.$v['version_num'].'</span> <a href="/a/post_drawings.php?action=version_info&version_id='.$v['id'].'">Version Settings</a>'.($v['published']?' (Published)':'').'</td>';
				echo '</tr>';
				echo '<tr>';
