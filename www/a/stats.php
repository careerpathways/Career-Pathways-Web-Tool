...
<div style="float:right; width:220px; border: 1px #999 solid; font-size: 1.2em; line-height: 1.6em;">
	<ul style="margin:0; padding: 10px; list-style-type: none;">
		<li><a href="#user_stats">User Stats</a></li>
		<li><a href="#drawing_counts">Drawing Counts</a></li>
		<li><a href="#editing_history">Editing History</a></li>
		<li><a href="#olmis_links">OLMIS Links</a></li>
		<li><a href="#traffic_logs">Traffic Logs</a></li>
	</ul>
</div>
<?php

echo '<a name="user_stats"></a>';
